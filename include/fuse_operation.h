#ifndef _FUSE_OPERATION_H
#define _FUSE_OPERATION_H
...
struct fuse_ops{
	 ...
	 */
	void (*lookup) (fuse_req_p req, fuse_inode parent, const char *name);
	 ...
	 */
	void (*forget) (fuse_req_p req, fuse_inode ino, uint64_t nlookup);
	 ...
	 */
	void (*getattr) (fuse_req_p req, fuse_inode ino,
	 ...
	 */
	void (*setattr) (fuse_req_p req, fuse_inode ino, struct stat *attr,
	 ...
	 * @param ino the inode number
	 */
	void (*readlink) (fuse_req_p req, fuse_inode ino);
	 ...
	 */
	void (*mknod) (fuse_req_p req, fuse_inode parent, const char *name,
	 ...
	 */
	void (*mkdir) (fuse_req_p req, fuse_inode parent, const char *name,
		       mode_t mode);
	 ...
	 */
	void (*unlink) (fuse_req_p req, fuse_inode parent, const char *name);
	 ...
	 * @param name to remove
	 */
	void (*rmdir) (fuse_req_p req, fuse_inode parent, const char *name);
	 ...
	 * @param name to create
	 */
	void (*symlink) (fuse_req_p req, const char *link, fuse_inode parent,
			 const char *name);
	 ...
	 */
	void (*rename) (fuse_req_p req, fuse_inode parent, const char *name,
	 ...
	 */
	void (*link) (fuse_req_p req, fuse_inode ino, fuse_inode newparent,
		      const char *newname);
	 ...
	 */
	void (*open) (fuse_req_p req, fuse_inode ino,
		      struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*read) (fuse_req_p req, fuse_inode ino, size_t size, off_t off,
		      struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*write) (fuse_req_p req, fuse_inode ino, char *buf,
	 ...
	 */
	void (*flush) (fuse_req_p req, fuse_inode ino,
		       struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*release) (fuse_req_p req, fuse_inode ino,
			 struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*fsync) (fuse_req_p req, fuse_inode ino, int datasync,
		       struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*opendir) (fuse_req_p req, fuse_inode ino,
			 struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*readdir) (fuse_req_p req, fuse_inode ino, size_t size, off_t off,
			 struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*releasedir) (fuse_req_p req, fuse_inode ino,
			    struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*fsyncdir) (fuse_req_p req, fuse_inode ino, int datasync,
			  struct fuse_file_info *fi);
	 ...
	 */
	void (*statfs) (fuse_req_p req, fuse_inode ino);
	 ...
	 *   fuse_reply_err
	 */
	void (*setxattr) (fuse_req_p req, fuse_inode ino, const char *name,
	 ...
	 */
	void (*getxattr) (fuse_req_p req, fuse_inode ino, const char *name,
			  size_t size);
	 ...
	 */
	void (*listxattr) (fuse_req_p req, fuse_inode ino, size_t size);
	 ...
	 * @param name of the extended attribute
	 */
	void (*removexattr) (fuse_req_p req, fuse_inode ino, const char *name);
	 ...
	 */
	void (*access) (fuse_req_p req, fuse_inode ino, int mask);
	 ...
	 * @param fi file information
	 */
	void (*create) (fuse_req_p req, fuse_inode parent, const char *name,
	 ...
	 */
	void (*getlk) (fuse_req_p req, fuse_inode ino,
	 ...
	 */
	void (*setlk) (fuse_req_p req, fuse_inode ino,
		       struct fuse_file_info *fi,
	 ...
	 */
	void (*bmap) (fuse_req_p req, fuse_inode ino, size_t blocksize,
		      uint64_t idx);

#if FUSE_USE_VERSION < 35
	void (*ioctl) (fuse_req_p req, fuse_inode ino, int cmd,
	 ...
	 */
	void (*ioctl) (fuse_req_p req, fuse_inode ino, unsigned int cmd,
		       void *arg, struct fuse_file_info *fi, unsigned flags,
		       const void *in_buf, size_t in_bufsz, size_t out_bufsz);
#endif
	 ...
	 */
	void (*poll) (fuse_req_p req, fuse_inode ino, struct fuse_file_info *fi,
	 ...
	 * @param fi file information
	 */
	void (*write_buf) (fuse_req_p req, fuse_inode ino,
	 ...
	 */
	void (*retrieve_reply) (fuse_req_p req, void *cookie, fuse_inode ino,
	 ...
	 * @param req request handle
	 */
	void (*forget_multi) (fuse_req_p req, size_t count,
	 ...
	 */
	void (*flock) (fuse_req_p req, fuse_inode ino,
	 ...
	 *             see fallocate(2)
	 */
	void (*fallocate) (fuse_req_p req, fuse_inode ino, int mode,
	 ...
	 * @param fi file information
	 */
	void (*readdirplus) (fuse_req_p req, fuse_inode ino, size_t size, off_t off,
			 struct fuse_file_info *fi);
	 ...
	 */
	void (*copy_file_range) (fuse_req_p req, fuse_inode ino_in,
				 off_t off_in, struct fuse_file_info *fi_in,
				 fuse_inode ino_out, off_t off_out,
	 ...
	 * @param fi file information
	 */
	void (*lseek) (fuse_req_p req, fuse_inode ino, off_t off, int whence,
		       struct fuse_file_info *fi);
};
